...
public class AutomataEntityModel extends BipedEntityModel<AutomataEntity> {
    ...
    public AutomataEntityModel(ModelPart root, boolean thinArms) {
...
//        }
    ...
    public void setAngles(AutomataEntity livingEntity, float f, float g, float h, float i, float j) {
